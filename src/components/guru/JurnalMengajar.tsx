...
export const JurnalMengajarView: React.FC<JurnalMengajarProps> = ({
  ...
  const rekapStats = useMemo(() => {
    ...
    const totalSiswa = totalHadir + totalTidakHadir;
    const persenKehadiran = totalSiswa > 0 ? Math.round((totalHadir / totalSiswa) * 100) : 0;
  ...
  const handleExportExcel = () => {
    try {
      ...
      const dataRows = filteredRekapanJurnal.map((j, index) => ({
        ...
        'Siswa Hadir': j.jumlahHadir,
        'Siswa Tidak Hadir': j.jumlahTidakHadir,
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Filter, analisis kehadiran siswa, ekspor ke format Excel/CSV, dan cetak lembar agenda resmi
                </p>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 print:hidden">
            ...
            <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-xs flex items-center gap-3">
              ...
              <div>
                <p className="text-[11px] font-bold text-slate-400 uppercase">Siswa Terdata</p>
